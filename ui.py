...
class C:
    ...
    PANEL2    = "rgba(45, 45, 50, 0.4)"
    BORDER    = "rgba(255, 255, 255, 0.15)"
    BORDER_B  = "rgba(255, 255, 255, 0.3)"
    BORDER_A  = "rgba(255, 255, 255, 0.2)"
    PRI       = "#34c759"
    PRI_DIM   = "#248a3d"
    PRI_GHO   = "rgba(52, 199, 89, 0.1)"
    ACC       = "#0a84ff"
    ACC2      = "#5e5ce6"
    GREEN     = "#34c759"
    GREEN_D   = "#248a3d"
    ...
    TEXT_MED  = "#d1d1d6"
    WHITE     = "#ffffff"
    DARK      = "rgba(10, 10, 12, 0.9)"
    BAR_BG    = "rgba(0, 0, 0, 0.3)"
...
class HudCanvas(QWidget):
    ...
    def _paint_core(self, p: QPainter, cx: float, cy: float, r: float,
        ...
        if name:
            ...
            f = QFont("-apple-system", fsz, QFont.Weight.Bold)
    ...
    def paintEvent(self, _):
        ...
        p.setPen(QPen(col, 1))
        p.setFont(QFont("-apple-system", 11, QFont.Weight.Bold))
...
class MetricBar(QWidget):
    ...
    def paintEvent(self, _):
        ...
        p.setFont(QFont("-apple-system", 7, QFont.Weight.Bold))
...
class LogWidget(QTextEdit):
    ...
    def __init__(self, parent=None):
        ...
        self.setFont(QFont("-apple-system", 9))
...
class _DropCanvas(QWidget):
    ...
    def _paint_idle(self, p, W, H, hover):
        ...
        p.setFont(QFont("-apple-system", 8))
    ...
    def _paint_drag_over(self, p, W, H):
        ...
        p.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
        p.setPen(QPen(qcol(C.PRI), 1))
    ...
    def _paint_file(self, p, W, H):
        ...
        p.setFont(QFont("-apple-system", 6))
...
class _CameraPreview(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        title.setFont(QFont("-apple-system", 7, QFont.Weight.Bold))
        title.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        hdr.addWidget(title)
        hdr.addStretch()
        close_btn = QPushButton("✕")
        close_btn.setFixedSize(16, 16)
        close_btn.setFont(QFont("-apple-system", 8))
...
class SetupOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        def _lbl(txt, font_size=9, bold=False, color=C.PRI,
            ...
            w.setFont(QFont("-apple-system", font_size,
        ...
        self._key_input.setFont(QFont("-apple-system", 10))
        ...
        for key, label in [("windows","⊞  Windows"),("mac","  macOS"),("linux","🐧  Linux")]:
            ...
            btn.setFont(QFont("-apple-system", 9, QFont.Weight.Bold))
        ...
        init_btn.setFont(QFont("-apple-system", 10, QFont.Weight.Bold))
...
class CustomizeOverlay(QWidget):
    ...
    def __init__(self, assistant_name="JARVIS", user_name="",
        ...
        def _lbl(txt, fs=9, bold=False, color=C.PRI, align=Qt.AlignmentFlag.AlignCenter):
            ...
            w.setFont(QFont("-apple-system", fs,
                            QFont.Weight.Bold if bold else QFont.Weight.Normal))
            w.setStyleSheet(f"color: {color}; background: transparent;")
            return w
        ...
        self._name_input.setFont(QFont("-apple-system", 10))
        ...
        self._user_input.setFont(QFont("-apple-system", 10))
        ...
        for _v in AVAILABLE_VOICES:
            ...
            b.setCheckable(True)
            b.setFixedHeight(28)
            b.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
        ...
        df_btn.setFont(QFont("-apple-system", 7, QFont.Weight.Bold))
        ...
        self._hex_input.setFont(QFont("-apple-system", 10))
        ...
        save_btn.setFont(QFont("-apple-system", 9, QFont.Weight.Bold))
        ...
        cancel_btn.setFont(QFont("-apple-system", 9))
...
class PluginManagerOverlay(QWidget):
    ...
    def __init__(self, plugins: list[dict], parent=None):
        ...
        hdr.setFont(QFont("-apple-system", 12, QFont.Weight.Bold))
        ...
        if not plugins:
            ...
            empty.setFont(QFont("-apple-system", 8))
        ...
        close_btn.setFont(QFont("-apple-system", 9))
        close_btn.setCursor(Qt.CursorShape.PointingHandCursor)
    ...
    def _build_row(self, p: dict) -> QHBoxLayout:
        ...
        lbl.setFont(QFont("-apple-system", 8))
        ...
        btn.setFont(QFont("-apple-system", 7, QFont.Weight.Bold))
        if not p["valid"]:
            btn.setText("BROKEN")
...
class ConfirmBanner(_HudOverlay):
    ...
    def __init__(self, title: str, detail: str, parent=None):
        ...
        hdr = QLabel("⚠  CONFIRM")
        hdr.setFont(QFont("-apple-system", 11, QFont.Weight.Bold))
        hdr.setStyleSheet(f"color: {C.ACC}; background: transparent;")
        lay.addWidget(hdr)

        ttl = QLabel(title)
        ttl.setWordWrap(True)
        ttl.setFont(QFont("-apple-system", 10, QFont.Weight.Bold))
        ...
        if detail:
            ...
            dtl.setFont(QFont("-apple-system", 8))
        ...
        yes.setFont(QFont("-apple-system", 9, QFont.Weight.Bold))
        ...
        no.setFont(QFont("-apple-system", 9))
...
class AudioDeviceOverlay(_HudOverlay):
    ...
    def __init__(self, parent=None):
        ...
        def _row(label: str, kind: str, current: str) -> QComboBox:
            cap = QLabel(label)
            cap.setFont(QFont("-apple-system", 8))
            cap.setStyleSheet(f"color: {C.TEXT_DIM}; background: transparent;")
            lay.addWidget(cap)

            box = QComboBox()
            box.setFont(QFont("-apple-system", 9))
        ...
        note.setFont(QFont("-apple-system", 7))
        ...
        ok.setFont(QFont("-apple-system", 9, QFont.Weight.Bold))
        ...
        cancel.setFont(QFont("-apple-system", 9))
...
class MemoryOverlay(_HudOverlay):
    ...
    def _rebuild(self):
        ...
        cap.setFont(QFont("-apple-system", 7))
        cap.setStyleSheet(f"color: {C.TEXT_DIM}; background: transparent;")
        self._lay.addWidget(cap)

        if not rows:
            empty = QLabel("Nothing stored yet.")
            empty.setFont(QFont("-apple-system", 9))
        ...
        close.setFont(QFont("-apple-system", 9))
...
class ClipboardPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        icon_lbl.setFont(QFont("-apple-system", 7, QFont.Weight.Bold))
        icon_lbl.setStyleSheet(f"color: {C.ACC2}; background: transparent;")
        hdr.addWidget(icon_lbl); hdr.addStretch()
        x_btn = QPushButton("✕")
        x_btn.setFixedSize(16, 16)
        x_btn.setFont(QFont("-apple-system", 8))
        ...
        self._preview.setFont(QFont("-apple-system", 8))
        ...
        for label, cmd_fmt in [
            ...
            b = QPushButton(label)
            b.setFixedHeight(22)
            b.setFont(QFont("-apple-system", 7, QFont.Weight.Bold))
            b.setCursor(Qt.CursorShape.PointingHandCursor)
            b.setStyleSheet(_bs)
    ...
    def _build_section(self, form: QVBoxLayout, sec: dict):
        ...
        for field in fields:
            ...
            if ftype == "choice":
                ...
                w.setFont(QFont("-apple-system", 9))
                w.setFixedHeight(30)
                w.setStyleSheet(
                    f"QComboBox {{ background: #000d12; color: {C.TEXT}; "
                ...
                w.setFixedHeight(28)
                w.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
                ...
                w.setFont(QFont("-apple-system", 10))
                w.setFixedHeight(30)
        ...
        if isinstance(action, dict) and callable(action.get("run")):
            ...
            ab.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
...
class RemoteKeyOverlay(QWidget):
    ...
    def __init__(self, url: str, key: str, auto_login_url: str = "",
        ...
        self._url_lbl.setFont(QFont("-apple-system", 8))
        ...
        self._key_lbl.setFont(QFont("-apple-system", 28, QFont.Weight.Bold))
        ...
        self._timer_lbl.setFont(QFont("-apple-system", 8))
        ...
        new_btn.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
        ...
        close_btn.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
        close_btn.setCursor(Qt.CursorShape.PointingHandCursor)
        close_btn.setStyleSheet(f"""
            QPushButton {{
                background: transparent; color: {C.TEXT_MED};
    ...
    def _update_qr(self, url: str) -> None:
        ...
        try:
            ...
            self._qr_label.setFont(QFont("-apple-system", 8))
            self._qr_label.setStyleSheet(
                "color: #888; background: white; border-radius: 10px; padding: 4px;"
            )
        except Exception:
            self._qr_label.setText(url[:28])
            self._qr_label.setFont(QFont("-apple-system", 7))
            self._qr_label.setStyleSheet(
    ...
    def mark_connected(self) -> None:
        ...
        """)
        self._qr_label.setText("✓")
        self._qr_label.setFont(QFont("-apple-system", 54, QFont.Weight.Bold))
        self._qr_label.setStyleSheet(
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        ...
        self.setStyleSheet(f"""
            ...
            QWidget {{ color: {C.TEXT}; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; }}
            QPushButton {{
        ...
        _cam_title.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
        _cam_title.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        _cam_hdr.addWidget(_cam_title)
        _cam_hdr.addStretch()
        _cam_x = QPushButton("✕  CLOSE")
        _cam_x.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
    ...
    def _build_header(self) -> QWidget:
        ...
        def _badge(txt, color=C.TEXT_MED):
            l = QLabel(txt)
            l.setFont(QFont("-apple-system", 8))
        ...
        self._drawer_btn.setFont(QFont("-apple-system", 11))
        ...
        self._title_lbl.setFont(QFont("-apple-system", 17, QFont.Weight.Bold))
        ...
        self._sub_lbl.setFont(QFont("-apple-system", 7))
        ...
        self._clock_lbl.setFont(QFont("-apple-system", 14, QFont.Weight.Bold))
        self._clock_lbl.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        self._clock_lbl.setAlignment(Qt.AlignmentFlag.AlignRight)
        right_col.addWidget(self._clock_lbl)
        self._date_lbl = QLabel("")
        self._date_lbl.setFont(QFont("-apple-system", 7))
    ...
    def _build_left_panel(self) -> QWidget:
        ...
        hdr.setFont(QFont("-apple-system", 7, QFont.Weight.Bold))
        hdr.setStyleSheet(f"color: {C.PRI}; background: transparent; "
        ...
        self._uptime_lbl.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
        self._uptime_lbl.setStyleSheet(f"color: {C.GREEN}; background: transparent; border: none;")
        ip_lay.addWidget(self._uptime_lbl)

        self._proc_lbl = QLabel("PROC  --")
        self._proc_lbl.setFont(QFont("-apple-system", 8))
        self._proc_lbl.setStyleSheet(f"color: {C.TEXT_MED}; background: transparent; border: none;")
        ip_lay.addWidget(self._proc_lbl)

        os_name = {"Windows": "WIN", "Darwin": "macOS", "Linux": "LINUX"}.get(_OS, _OS.upper())
        os_lbl = QLabel(f"OS  {os_name}")
        os_lbl.setFont(QFont("-apple-system", 8))
        ...
        for txt, col in [
            ...
            lbl = QLabel(txt)
            lbl.setFont(QFont("-apple-system", 7, QFont.Weight.Bold))
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        def _sec(txt):
            l = QLabel(f"▸ {txt}")
            l.setFont(QFont("-apple-system", 7, QFont.Weight.Bold))
        ...
        self._file_hint.setFont(QFont("-apple-system", 7))
        ...
        self._interrupt_btn.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
        ...
        self._mute_btn.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
    ...
    def _build_quick_drawer(self) -> QWidget:
        ...
        remote_btn.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
        ...
        fs_btn.setFont(QFont("-apple-system", 7))
        ...
        sc_btn.setFont(QFont("-apple-system", 7))
        ...
        self._autostart_btn.setFont(QFont("-apple-system", 7))
        ...
        cust_btn.setFont(QFont("-apple-system", 7))
        ...
        self._brief_btn.setFont(QFont("-apple-system", 7))
        ...
        self._wake_btn.setFont(QFont("-apple-system", 7))
        ...
        self._wake_sleep_btn.setFont(QFont("-apple-system", 7))
        ...
        self._ptt_btn.setFont(QFont("-apple-system", 7))
        ...
        self._hud_btn.setFont(QFont("-apple-system", 7))
        ...
        audio_btn.setFont(QFont("-apple-system", 7))
        ...
        mem_btn.setFont(QFont("-apple-system", 7))
        ...
        plugin_btn.setFont(QFont("-apple-system", 7))
        ...
        settings_btn.setFont(QFont("-apple-system", 7))
    ...
    def _build_input_row(self) -> QHBoxLayout:
        ...
        self._input.setFont(QFont("-apple-system", 9))
        ...
        send.setFont(QFont("-apple-system", 11, QFont.Weight.Bold))
    ...
    def _build_content_panel(self) -> QWidget:
        ...
        dot = QLabel("◈")
        dot.setFont(QFont("-apple-system", 9, QFont.Weight.Bold))
        dot.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        hdr.addWidget(dot)

        self._content_title_lbl = QLabel("BRIEFING")
        self._content_title_lbl.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
        ...
        self._content_ts_lbl.setFont(QFont("-apple-system", 7))
        self._content_ts_lbl.setStyleSheet(f"color: {C.TEXT_DIM}; background: transparent;")
        hdr.addWidget(self._content_ts_lbl)

        dismiss = QPushButton("DISMISS  ✕")
        dismiss.setFont(QFont("-apple-system", 7))
        ...
        self._content_display.setFont(QFont("-apple-system", 8))
    ...
    def _quiz_btn(self, text: str, primary: bool = False) -> QPushButton:
        b = QPushButton(text)
        b.setFont(QFont("-apple-system", 8))
        b.setCursor(Qt.CursorShape.PointingHandCursor)
    ...
    def _build_quiz_panel(self) -> QWidget:
        ...
        self._quiz_title_lbl.setFont(QFont("-apple-system", 8, QFont.Weight.Bold))
        ...
        self._quiz_count_lbl.setFont(QFont("-apple-system", 7))
        ...
        quit_btn.setFont(QFont("-apple-system", 7))
        ...
        self._quiz_q_lbl.setFont(QFont("-apple-system", 9))
        ...
        self._quiz_note_lbl.setFont(QFont("-apple-system", 8))
    ...
    def _quiz_render(self):
        ...
        if opts:
            ...
            field = QLineEdit()
            field.setFont(QFont("-apple-system", 9))
    ...
    def _build_footer(self) -> QWidget:
        ...
        def _fl(txt, color=C.TEXT_MED):
            l = QLabel(txt); l.setFont(QFont("-apple-system", 7))
            l.setStyleSheet(f"color: {color}; background: transparent;")
            return l
